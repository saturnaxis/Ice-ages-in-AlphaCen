...
ax_list = [ax11,ax11,ax11,ax11,ax11,ax11,ax11,ax11,ax11]
...
for j in range(1,2):
    ...
    for i in range(0,1):
        ...
        if i == 0 and j == 1:
            ax.text(0.00,1.02,"ice free", color='k',fontsize='medium',weight='bold',horizontalalignment='left',transform=ax.transAxes)
            ax.text(0.24,1.02,"ice caps", color='gray',fontsize='medium',weight='bold',horizontalalignment='left',transform=ax.transAxes)
            ax.text(0.5,1.02,"ice belt", color='b',fontsize='medium',weight='bold',horizontalalignment='left',transform=ax.transAxes)
            ax.text(0.75,1.02,"snowball", color='r',fontsize='medium',weight='bold',horizontalalignment='left',transform=ax.transAxes)
        if i > 2:
            ax.set_xticklabels([])
        else:
...
fig.savefig(plot_dir+"Fig12a.png",bbox_inches='tight',dpi=300)
plt.close()